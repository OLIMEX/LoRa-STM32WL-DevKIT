 ...
 *
 * It was generated by the irq2nvic_h script from ./include/libopencm3/sam/3a/irq.json
 */
...
/** @defgroup CM3_nvic_defines_irqs User interrupts for Atmel SAM3A series
